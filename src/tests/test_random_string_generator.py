...
class TestRandomStringGenerator(unittest.TestCase):
    ...
    def test_random_string_length_10(self):
        length = 10
        random_string = self.random_string_generator.generate_random_string(length)
        self.assertEqual (len(random_string), length)

    def test_random_string_different_between_runs(self):
        length = 10
        random_string_1 = self.random_string_generator.generate_random_string(length)
        random_string_2 = self.random_string_generator.generate_random_string(length)
